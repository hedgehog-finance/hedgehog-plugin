...
import { BuildDeepReasoningMessageAgentToolSchema, BuildDeepReasoningMessageParamsSchema, GetDeepReasoningDetailBySessionParamsSchema, GetDeepReasoningDetailParamsSchema, QueryDeepReasoningHistoryParamsSchema } from "./schema.js";
...
function mapRowToDeepReasoning(row) {
...
function selectGeneratingDeepReasoning(sourceId, market, sessionId) {
    ...
    if (normalizedSessionId) {
        ...
        if (bySession)
            return mapRowToDeepReasoning(bySession);
    }
...
function createGeneratingDeepReasoning(args) {
    const db = getDB();
